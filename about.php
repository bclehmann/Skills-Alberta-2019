...
<html>
    <head>
        <title>Rapid Air | About Us</title>
        <meta charset="UTF=8">
    ...
    <body>
        <div class="container">
        	...
        	<div id="body">
        		<p><img class="floatRight sidebarImg" src="/Images/Small Plane2.jpg">
...
<br/>
<h4>A Continued Policy of Success</h4>
...
<br/>
<h4>Confidently Tackling Challenges</h4>
...
The Rapid Air flight operations schedule fluctuates seasonally due to their regulation to operate in daylight only. This means a more condensed schedule in the winter months and a longer, more expansive schedule throughout the summer months. Despite this, Rapid Air employs 400+ full time year round employees and operates over 30,000 flights yearly to all of its destinations.
<br />
<h4>Daily Business</h4>
Freight services are available on all aircraft, all routes and, when in flight, are the direct responsibility of all aircrew. Aircrew receive specialized training on freight shipment policies to ensure that parcels being shipped by Rapid Air are handled with care throughout their transport.
<img class="floatLeft sidebarImg" src="/Images/Pilot.jpg">
