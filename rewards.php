    ...
    <body>
        <div class="container">
        	...
        	<div id="body">
        		...
        		<h4>Ready to start earning High Flyer Rewards points?</h4>
        		<p>
        			All you have to do is join the program and start flying! Points add up quickly and you'll be redeeming yours for great rewards before you know it.
Membership Levels
        		</p>
        		
        		<h4>The High Flyer Rewards Program offers two levels of membership</h4>
        		<ul>
        			<li>
        				<h5>Level 1 - High Flyer - 0 to 99 flights</h5>
        				<p>Anyone can join as a High Flyer member to begin earning points. Points are earned at a rate of 10% of the base fare per flight and can be redeemed for flights and other great rewards at any time. Points can be earned on domestic and international scheduled service flights and panorama tours operated by Rapid Air, Whistler Air, Saltspring Air and Tantalus Air.
        				</p>
        			</li>
        			<li>
        				<h5>Level 2 - Elite High Flyer - 100+ flights</h5>
        		...
        		<h4>Level 2 - Elite High Flyer</h4>
        		<ul>
        			<li>Personalized card</li>
        			<li>Priority baggage handling</li>
        			<li>Select Seat upgrades (subject to availability)</li>
        			<li>Priority flight interruption notifications</li>
        			<li>Priority reservation waitlist</li>
        			<li>Discounts on flights & parcel express services</li>
        			<li>Complimentary valet (location specific)</li>
        			<li>Complimentary SOLO Electric Vehicle rentals (location specific)</li>
        		</ul>
